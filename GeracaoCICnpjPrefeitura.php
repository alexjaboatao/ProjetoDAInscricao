		...
		<html>
		 ...
		 <body>
		   ...
		   <div id='formatacaoTitulo'>
			 <b>Assunto: </b>
			 Débitos de natureza {$natureza} lançados no CNPJ da Prefeitura do Jaboatão dos Guararapes<br />
		   </div>
		   
		   <div id='formatacaoTexto'>
			 <p>Prezado(a) {$destinatario},<br/></p>
			 <p>Cumprimentando-o(a) cordialmente, servimo-nos da oportunidade para informar que os débitos listados em anexo não foram inscritos em Dívida Ativa, 
			 uma vez que foram lançados no CNPJ 10.377.679/0001-96, pertencente a Prefeitura Municipal do Jaboatão dos Guararapes. Desta forma, solicitamos que sejam 
			 ajustados no cadastro, nos casos aplicáveis, para posterior inscrição em Dívida Ativa.</p>
