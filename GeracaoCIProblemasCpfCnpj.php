		...
		<html>
		 ...
		 <body>
		   ...
		   <div id='formatacaoTitulo'>
			 <b>Assunto: </b>
			 Débitos de natureza {$natureza} com dados inválidos para inscrição em Dívida Ativa<br />
		   </div>
		   
		   <div id='formatacaoTexto'>
			 <p>Prezado(a) {$destinatario},<br/></p>
			 <p>Cumprimentando-o(a) cordialmente, servimo-nos da oportunidade para informar que os débitos de natureza {$natureza} que seguem em anexo não foram inscritos em Dívida Ativa, 
			 uma vez que seus dados são insuficientes para a devida Cobrança Administrativa e posterior ajuizamento, se necessário. 
			 Deste modo, por não atendimento aos requisitos do Art 181, Lei nº 155/91 e para evitar futuros transtornos para esta PMJG, a Gerência de Tributos Imobiliários, 
			 Arrecadação e Dívida Ativa – GTIAD, decidiu por não inscrevê-los.
			</p>
			
			<p>Desta forma, solicitamos que sejam providenciados os devidos ajustes no cadastro, a fim de que possamos realizar estas inscrições em Dívida Ativa.</p>
